        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                icon: _buildNavIcon(
                    Icons.storefront_outlined, Icons.storefront, 1),
                label: 'Products',
              ),
              BottomNavigationBarItem(
...
// Add this to your main_screen.dart
class MainScreenWithTab extends StatefulWidget {
  final int initialIndex;
  
  const MainScreenWithTab({Key? key, this.initialIndex = 0}) : super(key: key);

  @override
  _MainScreenWithTabState createState() => _MainScreenWithTabState();
}
